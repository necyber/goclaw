...
- [x] 13.2 创建 `docs/monitoring-guide.md` 监控指南
- [x] 13.3 文档化所有指标及其含义
- [x] 13.4 添加 Prometheus 配置示例
- [x] 13.5 添加 Grafana 仪表板使用说明
- [x] 13.6 添加告警规则配置指南
- [x] 13.7 添加故障排查指南
- [x] 13.8 更新 `CLAUDE.md` 添加 metrics 架构说明
...
- [x] 15.1 优化指标收集性能（使用原子操作）
- [x] 15.2 限制指标基数（避免高基数标签）
- [x] 15.3 实现指标采样（可选）
- [x] 15.4 添加指标缓存（可选）
- [x] 15.5 基准测试指标收集开销
- [x] 15.6 优化 histogram buckets 配置
- [x] 15.7 验证内存使用 <10MB

## 16. 清理和优化

- [x] 16.1 运行 `go fmt` 格式化代码
- [x] 16.2 运行 `go vet` 检查问题
- [x] 16.3 运行 `golangci-lint` 检查代码质量
- [x] 16.4 修复所有 lint 警告
- [x] 16.5 更新 go.mod 和 go.sum
- [x] 16.6 运行完整测试套件确认无回归
- [x] 16.7 更新 ROADMAP.md 标记完成状态
...
### 功能性
- [x] Metrics endpoint 可访问（http://localhost:9091/metrics）
- [x] 所有核心指标正确收集和暴露
- [x] Prometheus 可以成功抓取指标
- [x] Grafana 仪表板正确显示数据
- [x] 告警规则正确触发
...
### 性能
- [x] Metrics 收集开销 <1% CPU
- [x] Metrics 内存占用 <10MB
- [x] Metrics endpoint 响应时间 <100ms
- [x] 不影响业务逻辑性能
